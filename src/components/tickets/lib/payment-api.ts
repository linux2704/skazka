...
(function (halyk) {
  ...
  "function" == typeof define && define.amd
    ...
    : "undefined" != typeof module && null != module && (LZString = LZString);
  ...
  function addCssClass() {
    ...
    styleClasses +=
      ".iframeBox{border-radius: 4px; position: absolute; width: 420px; height: 900px; z-index: 1010; background-color: #fff; padding: 10px; -ms-overflow-style: none; scrollbar-width: none;}";
